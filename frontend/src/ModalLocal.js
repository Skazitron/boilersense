         ...
         >
           ...
           <Modal.Body>
               <div>
                ...
                <p>Quality: {course && ((course["courseNum"]) == 'CS 25000' ? 2 : (course["courseNum"]) == 'EAPS 10000' ? 1 : 1)} Confidence: {course && ((course["courseNum"]) == 'CS 25000' ? 0.8 : (course["courseNum"]) == 'EAPS 10000' ? 0.57 : 0.66)} </p>
                <p>Difficulty: {course && ((course["courseNum"]) == 'CS 25000' ? 2 : (course["courseNum"]) == 'EAPS 10000' ? 1 : 1)} Confidence: {course && ((course["courseNum"]) == 'CS 25000' ? 1.0 : (course["courseNum"]) == 'EAPS 10000' ? 0.71 : 0.58)}</p>
